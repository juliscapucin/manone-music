...
/*!*******************************************!*\
  !*** ./src/page-transition-enter/view.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
...
class PageTransitionEnter {
  constructor() {
    ["load", "init", "animateOnLoad"].forEach(fn => this[fn] = this[fn].bind(this));
    this.load();
  }
  async init() {
    console.log("Hello from PageTransitionEnter");
    this.pageTransitionDiv = document.querySelector("[js-hook-page-transition-enter]");
