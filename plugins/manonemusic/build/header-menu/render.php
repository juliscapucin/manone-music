...
if (count($links) > 0) {
   ...
   foreach ($links as $link) {
      echo '<li role="none" class="pointer-events-auto' . ($link['slug'] == '/home' ? ' lg:hidden ' : '') . '"><a role="menuitem" href="' . $link['slug'] . '" class="underlined-link text-titleLarge lg:text-bodyMedium lg:underlined-link uppercase">' . $link['label'] . '</a></li>';
   }
   echo '
      </ul>
